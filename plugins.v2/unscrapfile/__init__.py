...
class UnscrapFile(_PluginBase):
    ...
    def init_plugin(self, config: dict = None):
        ...
        self._unscrapfiles =self._plugindata.get_data(plugin_id="LibraryScraper", key="unscrapfiles")
        # 停止现有任务
        self.stop_service()
    ...
    def __unscrapfile(self):
        ...
        self._ids =""
        self._plugindata.del_data(plugin_id="LibraryScraper", key="unscrapfiles")
